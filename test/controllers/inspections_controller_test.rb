...
class InspectionsControllerTest < ActionController::TestCase
  ...
  test "should create inspection" do
    assert_difference('Inspection.count') do
      post :create, inspection: { conclusion: @inspection.conclusion, date: @inspection.date, diagnostic: @inspection.diagnostic, name: @inspection.name, reason: @inspection.reason, report: @inspection.report, type: @inspection.type }
    end
  ...
  test "should update inspection" do
    patch :update, id: @inspection, inspection: { conclusion: @inspection.conclusion, date: @inspection.date, diagnostic: @inspection.diagnostic, name: @inspection.name, reason: @inspection.reason, report: @inspection.report, type: @inspection.type }
    assert_redirected_to inspection_path(assigns(:inspection))
  end
